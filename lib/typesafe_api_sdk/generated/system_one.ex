defmodule TypeSafeAPISDK.Generated.SystemOne do
  @moduledoc """
  Generated Typesafe API Sdk operations module `TypeSafeAPISDK.Generated.SystemOne`.
  """
  ...
  def create(client, params \\ %{}, opts \\ [])
    ...
    TypeSafeAPISDK.Client.execute_generated_request(client, request)
  end
  ...
  defp build_create_request(client, params, opts)
    ...
    %{
      ...
      request_schema: TypeSafeAPISDK.Generated.Schemas.SystemOneRequest,
      response_schemas: %{200 => TypeSafeAPISDK.Generated.Schemas.SystemOneResponse},
