defmodule TypeSafeAPISDK.Generated.Schemas.SystemOneResponse do
  @moduledoc """
  Generated Typesafe API Sdk type module `TypeSafeAPISDK.Generated.Schemas.SystemOneResponse`.
  """
  ...
  @type t :: %__MODULE__{
          answers: term(),
          model: String.t(),
          usage: TypeSafeAPISDK.Generated.Schemas.Usage.t()
        }
  @doc false
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        nullable: false,
        required: true,
        type: {TypeSafeAPISDK.Generated.Schemas.Usage, :t}
      }
    ]
  end
