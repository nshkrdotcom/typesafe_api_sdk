defmodule TypeSafeAPISDK.ResultClassifier do
  ...
  defp retry_policy(opts) when is_list(opts) do
    case Keyword.get(opts, :typesafe_api_retry_policy, %RetryPolicy{}) do
      false -> false
  ...
  defp timeout_reason?(reason), do: TypeSafeAPISDK.TransportError.timeout?(reason)
end
