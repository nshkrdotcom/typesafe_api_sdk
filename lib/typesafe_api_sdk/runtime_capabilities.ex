defmodule TypeSafeAPISDK.RuntimeCapabilities do
  @moduledoc "Fail-closed view of Pristine transport capabilities used by this API client."
  ...
  def check(client, requirements) when is_list(requirements) do
    ...
    if missing == [] do
      ...
      statuses =
        Map.new(missing, fn name -> {name, get_in(runtime, [name, :status]) || :unverified} end)
