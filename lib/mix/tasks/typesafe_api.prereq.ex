defmodule Mix.Tasks.TypesafeApi.Prereq do
  use Mix.Task

  alias Pristine.SDK.ProviderProfile

  @moduledoc false
  @shortdoc "Verifies the Pristine runtime contracts used by TypeSafeAPISDK"
  ...
  def run(_args) do
    ...
    Mix.shell().info("Pristine runtime prerequisite verified for TypeSafeAPISDK")
  end

  defp verify_status_ranges! do
    profile =
      ProviderProfile.new!(
        provider: :typesafe_api_prereq_probe,
        retryable_groups: [],
        status_retry_ranges: [
          %{
            range: 500..599,
  ...
  defp verify_cancellation_contract! do
    ...
    client = TypeSafeAPISDK.new_client(api_key: "typesafe-prereq-audit-only")
