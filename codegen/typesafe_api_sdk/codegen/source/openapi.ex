defmodule TypeSafeAPISDK.Codegen.Source.OpenAPI do
  alias TypeSafeAPISDK.Codegen.Provider, as: Provider
  ...
  @schema_modules %{
    "ChoiceAnswer" => TypeSafeAPISDK.Generated.Schemas.ChoiceAnswer,
    "ChoiceQuestion" => TypeSafeAPISDK.Generated.Schemas.ChoiceQuestion,
    "ModelMetadata" => TypeSafeAPISDK.Generated.Schemas.ModelMetadata,
    "ModelMetadataList" => TypeSafeAPISDK.Generated.Schemas.ModelMetadataList,
    "NoulAnswer" => TypeSafeAPISDK.Generated.Schemas.NoulAnswer,
    "NoulCriteria" => TypeSafeAPISDK.Generated.Schemas.NoulCriteria,
    "NoulQuestion" => TypeSafeAPISDK.Generated.Schemas.NoulQuestion,
    "ScoreAnswer" => TypeSafeAPISDK.Generated.Schemas.ScoreAnswer,
    "ScoreQuestion" => TypeSafeAPISDK.Generated.Schemas.ScoreQuestion,
    "SystemOneRequest" => TypeSafeAPISDK.Generated.Schemas.SystemOneRequest,
    "SystemOneResponse" => TypeSafeAPISDK.Generated.Schemas.SystemOneResponse,
    "Usage" => TypeSafeAPISDK.Generated.Schemas.Usage
  }
  @operation_specs [
    %{
      id: "system_one",
      path: "/v1/systemone",
      method: :post,
      module: TypeSafeAPISDK.Generated.SystemOne,
      function: :create,
      resource: "system_one"
    },
    %{
      ...
      path: "/v1/models",
      method: :get,
      module: TypeSafeAPISDK.Generated.Models,
      function: :list,
      resource: "models"
    }
  ]
  ...
  def refresh!(opts) do
    ...
    case :httpc.request(:get, request, http_options, body_format: :binary) do
      {:ok, {{_version, 200, _reason}, _headers, body}} ->
        ...
        validate_reviewed_surface!(decoded)
  ...
  defp schema_ref!("#/components/schemas/Question") do
    {:union,
     [
       {TypeSafeAPISDK.Generated.Schemas.NoulQuestion, :t},
       {TypeSafeAPISDK.Generated.Schemas.ChoiceQuestion, :t},
       {TypeSafeAPISDK.Generated.Schemas.ScoreQuestion, :t}
     ]}
  end
  ...
  defp schema_ref!("#/components/schemas/Answer") do
    {:union,
     [
       {TypeSafeAPISDK.Generated.Schemas.NoulAnswer, :t},
       {TypeSafeAPISDK.Generated.Schemas.ScoreAnswer, :t},
       {TypeSafeAPISDK.Generated.Schemas.ChoiceAnswer, :t}
     ]}
  end
  ...
  defp schema_ref!("#/components/schemas/" <> name) do
    case Map.fetch(@schema_modules, name) do
      ...
      :error ->
        raise(
          "OpenAPI schema #{name} is outside the reviewed TypeSafe API surface; " <>
  ...
  defp validate_union_aliases!(document) do
    for {name, members} <- [
      ...
      if actual && Enum.sort(actual) != Enum.sort(expected) do
        raise "OpenAPI union #{name} is outside the reviewed TypeSafe API surface"
      end
    end
  end

  defp validate_reviewed_surface!(document) do
