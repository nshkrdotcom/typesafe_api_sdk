defmodule TypeSafeAPISDK.Codegen.Provider do
  alias TypeSafeAPISDK.Codegen.Source.OpenAPI, as: OpenAPI

  @moduledoc false
  @behaviour PristineCodegen.Provider

  alias TypeSafeAPISDK.Constants
  ...
  def definition(_opts) do
    %{
      provider: %{
        id: :typesafe,
        base_module: TypeSafeAPISDK,
        client_module: TypeSafeAPISDK.Client,
        package_app: :typesafe_api_sdk,
        package_name: "typesafe_api_sdk",
        source_strategy: :openapi_snapshot
      },
      runtime_defaults: %{
        base_url: Constants.default_base_url(),
        default_headers: %{"Accept" => "application/json"},
        user_agent_prefix: "typesafe-api-sdk",
      ...
      artifact_plan: %{
        generated_code_dir: "lib/typesafe_api_sdk/generated",
        artifacts: [
    ...
    %{
      ...
      generated_code_dir:
        Keyword.get(
          opts,
          :generated_code_dir,
          Path.join(project_root, "lib/typesafe_api_sdk/generated")
        ),
  ...
  @impl true
  def source_plugins, do: [TypeSafeAPISDK.Codegen.Source.OpenAPI]
  @impl true
  def auth_plugins, do: []
  @impl true
